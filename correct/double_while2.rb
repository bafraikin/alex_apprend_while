...
arra_double[2]="You42want42a42Lamborghini?42Sippin'42martinis?".tr("4", " ").tr("2", "").split("")
...
arra_double[8]="42424242424242424242\n424242424242424242424242424242424242424".tr("4", '').tr("2", '').split("")
arra_double[9]="Signé:42Britney42à42la42plage,42la42sage".tr("4", " ").tr("2", "").split("")
...
while ligne < arra_double.size
  index = 0
  while index < arra_double[ligne].size
    print arra_double[ligne][index]
    index += 1
  end
  print "\n"
  ligne += 1
